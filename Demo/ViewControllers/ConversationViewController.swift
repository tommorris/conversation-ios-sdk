...
public class ConversationViewController: UIViewController, MessageComposeDelegate, ConversationViewDelegate {
    ...
    override public func viewDidLoad() {
        ...
        details.setTitle(conversation?.name, for: .normal)
    ...
    @objc
    @IBAction func onNavBarMembershipSelected() {
