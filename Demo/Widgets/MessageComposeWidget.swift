...
@IBDesignable public class MessageComposeWidget: UIView, UITextViewDelegate, ImageSelectionDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        sendButton.isEnabled = !TextEntry.text.isEmpty
    ...
    @IBAction func phoneButtonPressed(_ sender: UIButton) {
        let viewController = MessageComposeWidget.findParentViewController(view: self)
        
        do {
            try conversation?.audio.enable()
            
            viewController?.navigationController?.navigationBar.backgroundColor = UIColor.green
            viewController?.navigationController?.navigationBar.barTintColor = UIColor.green
